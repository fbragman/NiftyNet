...
class LearnedMTHighRes3DNet(BaseNet):
    ...
    def __init__(self,
        ...
        self.layers = [
            ...
            {'name': 'conv_2', 'n_features': 64, 'kernel_size': 3},
    ...
    def layer_op(self, images, is_training=True, layer_id=-1, **unused_kwargs):
        ...
        conv_layer = LearnedCategoricalGroupConvolutionalLayer(
            ...
            name=params['name'])
        grouped_flow, learned_mask, d_p = conv_layer(images,
                                                     tau_val,
                                                     is_training)
        ...
        conv_layer = LearnedCategoricalGroupConvolutionalLayer(
            ...
            w_regularizer=self.regularizers['w'],
            name=params['name'])
        grouped_flow, learned_mask, d_p = conv_layer(output_res_blocks,
                                                     tau_val,
                                                     is_training)
        layer_instances.append((conv_layer, grouped_flow))
        cat_instances.append((d_p, learned_mask))
        ...
        conv_layer = LearnedCategoricalGroupConvolutionalLayer(
            ...
            w_regularizer=self.regularizers['w'],
            name=params['name'])
        grouped_flow, learned_mask, d_p = conv_layer(grouped_flow,
                                                     tau_val,
                                                     is_training)
        layer_instances.append((conv_layer, grouped_flow))
        cat_instances.append((d_p, learned_mask))
